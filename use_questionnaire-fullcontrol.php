...
<body>
    <form action="bd.php" method="post" id="form">
        ...
        <input type="hidden" id="questionnarie_name" name="questionnarie_name" value="use_questionnaire_wearer-fullcontrol">
        
        
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">&laquo;</a><a class="navbar-brand" href="#" onclick="scrollTo('body')">Use Questionnaire (Full Control) (Post-Questionnaire)</a>
                </div>
...
<?php
	...
	createLikert5("12. I felt the wearable thermal comfort adequate.","1","12");
	createLikert5("13. I felt the different functionalities worked well together. ","1","13");
	createLikert5("14. I felt the different parts were well attached.","1","14");
	createLikert5("15. I felt like I need to pay minimal attention to the wearable. ","1","15");
	createLikert5("16. I felt the interactions with the wearable were simple.","1","16");
	createLikert5("17. I thought the wearable was attentive to changes in the environment around me. ","1","17");
	createLikert5("18. I felt easy moving my body while using the wearable.","1","18");
	//createLikert5("20. I felt like all the parts were integrated into the clothing.","1","20");
	createLikert5("19. I always knew what each part did.","1","19");
	createLikert5("20. I thought the wearable communicated well what was happening.","1","20");
	createLikert5("21. I felt I could easily access all the parts necessary.","1","21");
	createLikert5("22. I did bump into things. ","1","22");
	
	createSAM("23. Independently of my interactions with others, this is how I felt about using the GPS feature of the wearable: ","1","23");
	createSAM("24. Independently of my interactions with others, this is how I felt about using the camera feature of the wearable: ","1","24");
	createSAM("25. Independently of my interactions with others, this is how I felt about the notification feature of the wearable: ","1","25");	

    createComment("26. Please use the space below for additional comments on using the wearable:","1","26");	
?>	
